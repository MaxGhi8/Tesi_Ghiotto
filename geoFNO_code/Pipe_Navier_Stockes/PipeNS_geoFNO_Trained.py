"""
geoFNO per problem of Navier Stockes on a pipe, test rete giÃ  allenata
"""
...
class UnitGaussianNormalizer(object):
    """ 
    Initial normalization su x che Ã¨ un tensore di 
    ...
    def __init__(self, d_a, d_v, d_u, L, modes1, modes2):
        ...
        for _ in range(self.L):
            ...
            fourier = FourierLayer(
                self.d_v, self.d_v, self.modes1, self.modes2)
...
# 'cuda' se è disponibile la GPU, sennÃƒÂ² è 'cpu'
